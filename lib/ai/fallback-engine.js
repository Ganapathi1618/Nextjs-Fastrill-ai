// lib/ai/fallback-engine.js — Zero AI calls, always returns valid reply
...
function getFallbackReply({ intent, state, biz, services, firstName }) {
  ...
  if (primary === "greeting") return "Hi " + name + "! 👋 Welcome to *" + bizName + "*!" + (svcPrev ? "\n\nWe offer: " + svcPrev + " and more." : "") + "\n\nHow can I help you today? 😊"
  ...
  if (primary === "hours_query") return hours ? "⏰ *" + bizName + "* is open:\n\n" + hours + "\n\nAnything else? 😊" : "I'll confirm our working hours shortly! ⏰"
  ...
  if (primary === "booking_cancel")  return "I understand you want to cancel 😔\n\nWould you prefer to reschedule instead? We'd love to have you at *" + bizName + "*!"
  if (primary === "human_handoff" || primary === "complaint") return "Of course! 🙌 I'll notify our team right away and someone will be with you shortly.\n\nIs there anything specific you'd like me to mention?"
  if (primary === "gratitude")       return "You're welcome! 😊 Looking forward to seeing you at *" + bizName + "*!"
  ...
  return "Thanks for reaching out to *" + bizName + "*! 😊" + (svcPrev ? "\n\nWe offer: " + svcPrev + "." : "") + "\n\nHow can I help?\n📅 Book an appointment\n💰 Services & pricing\n📍 Our location"
}
