...
- my booking/active booking/upcoming/how many booking → show_bookings
...
function ruleBasedExtraction(message, state, services) {
  ...
  else if (/\b(my booking|active booking|upcoming|how many booking)\b/i.test(m)) action = "show_bookings"
