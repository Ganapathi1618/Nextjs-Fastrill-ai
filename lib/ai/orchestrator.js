...
If customer named a service, set action=collect_date. If they gave a date, set action=collect_time. If they confirmed, set action=do_booking.

JSON format:
{"reply":"<reply in ${replyLang}>","action":"<action>","extracted":{"service":"<name or null>","date":"<YYYY-MM-DD or null>","time":"<HH:MM or null>","confirmed":false},"language":"${replyLang}"}`
