...
• Upsell hair spa with every haircut booking`}
                    ...
                    <div style={{ background:"rgba(0,208,132,0.06)", border:`1px solid ${accent}22`, borderRadius:9, padding:"11px 13px", fontSize:12, color:textMuted, lineHeight:1.6 }}>
                      💡 <strong style={{ color:text }}>Pro tip:</strong> The more specific your instructions, the smarter your AI gets. Add rules like "If customer says reschedule/change booking, ask for new date and time" to handle edge cases.
                    </div>
                  </div>
                </div>
              </div>
