...
export default function SignupPage() {
  ...
  async function handleSendOTP(e) {
    ...
    try {
      ...
      setError(e.message?.includes("rate") ? "Too many attempts. Please wait a moment and try again." : e.message || "Failed to send code. Please try again.")
    ...
    <div style={{ minHeight: "100vh", background: "linear-gradient(135deg, #0a0a0a 0%, #1a1a2e 100%)", display: "flex", alignItems: "center", justifyContent: "center", padding: "20px", fontFamily: "'Inter', sans-serif" }}>
      <div style={{ width: "100%", maxWidth: "420px" }}>
        ...
        <div style={{ background: "#111", border: "1px solid #222", borderRadius: "16px", padding: "32px" }}>
          ...
          {step === "email" && (
            <>
              <h1 style={{ color: "#fff", fontSize: "22px", fontWeight: "700", marginBottom: "8px" }}>Create your account</h1>
              <p style={{ color: "#888", fontSize: "14px", marginBottom: "24px" }}>Start your free Fastrill account</p>

              {/* Google */}
              <button onClick={handleGoogleSignup} disabled={loading} style={{ width: "100%", padding: "12px", borderRadius: "10px", border: "1px solid #333", background: "#1a1a1a", color: "#fff", fontSize: "15px", fontWeight: "500", cursor: "pointer", display: "flex", alignItems: "center", justifyContent: "center", gap: "10px", marginBottom: "20px" }}>
              ...
              <div style={{ display: "flex", alignItems: "center", gap: "12px", marginBottom: "20px" }}>
                ...
                <span style={{ color: "#555", fontSize: "13px" }}>or use email</span>
                <div style={{ flex: 1, height: "1px", background: "#222" }} />
              </div>
              ...
              <p style={{ textAlign: "center", marginTop: "16px", color: "#555", fontSize: "12px" }}>
